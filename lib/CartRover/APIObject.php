	...
	protected static function curlError($errno, $message)
	{
		switch ($errno) {
			...
			case CURLE_OPERATION_TIMEOUTED:
				$msg = 'Could not connect to CartRover ('.APIObject::$api_base.'). Please check your internet connection and try again. If this problem persists please let us know at support@cartrover.com';
				break;
			case CURLE_SSL_CACERT:
			case CURLE_SSL_PEER_CERTIFICATE:
				$msg = 'Could not verify CartRover\'s SSL certificate. Make sure you can access '.APIObject::api_base.' in your browser and that your SSL version supports SNI. If this problem persists, let us know at support@cartrover.com';
				break;
			default:
				$msg = 'Unexpected error communicating with CartRover. If this problem persists please let us know at support@cartrover.com';
		}
